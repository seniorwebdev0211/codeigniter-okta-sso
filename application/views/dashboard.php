...
<div id="container">
	<h1>Welcome to Okta as the identity provider with CodeIgniter 3!</h1>

	<div id="body" style="text-align: center;margin: 50px auto;">
        <div>
            <h2>My Profile</h2>
            <p>Hello, <span style="color: blue;"><?php echo $profile['sub']; ?></span>! You have successfully logged in with your <a
